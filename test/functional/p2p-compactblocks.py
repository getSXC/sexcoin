...
# TestNode: A peer we use to send messages to sexcoind, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes sexcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that sexcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for sexcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # sexcoind will not send blocktxn responses for blocks whose height is
