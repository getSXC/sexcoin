...
- #6214 `87406aa` [OSX] revert renaming of Sexcoin-qt.app and use CFBundleDisplayName (partial revert of #6116) (Jonas Schnelli)
...
- #6600 `ef4945f` Include sexcoin-tx binary on Debian/Ubuntu (Zak Wilcox)
...
- #6390 `6a73d66` tests: Fix sexcoin-tx signing test case (Wladimir J. van der Laan)
...
- #6730 `cb4d6d0` build: Remove dependency of sexcoin-cli on secp256k1 (Wladimir J. van der Laan)
...
- #7209 `f3ad812` test: don't override sexcoind and BITCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6387 `11576a5` [sexcoin-cli] improve error output (Jonas Schnelli)
- #6401 `6db53b4` Add sexcoind_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
