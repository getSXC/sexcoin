...
- #8829 `2a8bca4` Add sexcoin-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_sexcoinds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update sexcoin-tx to output witness data (jnewbery)
