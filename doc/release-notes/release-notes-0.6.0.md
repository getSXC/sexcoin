...
in your terminal, then install the sexcoin-qt package.
...
Sexcoin-qt can display and save QR codes for sending
...
versions of Sexcoin-qt/sexcoind.
...
Sexcoin-qt's initial splash screen
...
opening/launching Sexcoin-qt is available only on Linux,
and only if you configure your desktop to launch
Sexcoin-qt. All platforms support dragging and dropping
bitcoin: URIs onto the Sexcoin-qt window to start
payment.
...
It is expected that future releases of Sexcoin-qt
